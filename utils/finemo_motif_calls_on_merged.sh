...
if [ ! -f "${output_dir}/finemo_out/hits_counts.tsv" ]; then
...
finemo call-hits -r motif_calls_counts.npz -m ${output_dir}/compiled_${model_head}/modisco_compiled.h5 -o finemo_out_counts -p ../${celltype}_peakset_all_no_blacklist.bed -J
finemo report -r motif_calls_counts.npz -H finemo_out_counts/hits_counts.tsv -p ../${celltype}_peakset_all_no_blacklist.bed -m ${output_dir}/compiled_${model_head}/modisco_compiled.h5 -o finemo_out_counts/report -W 2000
else

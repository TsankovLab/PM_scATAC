...
finemo call-hits -r motif_calls_${model_head}.npz -m ${chromBPdir}/compiled_${model_head}/modisco_compiled.h5 -o finemo_out_${model_head} -p ../${celltype}_peakset_all_no_blacklist.bed -J

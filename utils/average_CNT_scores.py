...
h5_counts_files = [
    f"no_bias_model/fold_0/contribution_scores.counts_scores.h5",
    f"no_bias_model/fold_1/contribution_scores.counts_scores.h5",
    f"no_bias_model/fold_2/contribution_scores.counts_scores.h5",
    f"no_bias_model/fold_3/contribution_scores.counts_scores.h5",
    f"no_bias_model/fold_4/contribution_scores.counts_scores.h5"
]  # List of H5 file paths

h5_profile_files = [
    f"no_bias_model/fold_0/contribution_scores.profile_scores.h5",
    f"no_bias_model/fold_1/contribution_scores.profile_scores.h5",
    f"no_bias_model/fold_2/contribution_scores.profile_scores.h5",
    f"no_bias_model/fold_3/contribution_scores.profile_scores.h5",
    f"no_bias_model/fold_4/contribution_scores.profile_scores.h5"
]  # List of H5 file paths
...
#                 print(f"Success: File '{file}' opened successfully.")
#         except OSError as e:
#             print(f"Error: Cannot open file '{file}'. Reason: {e}")

# check_h5_files (h5_files)
...
output_file = f"no_bias_model/{celltype}_averaged_contributions_profile.h5"

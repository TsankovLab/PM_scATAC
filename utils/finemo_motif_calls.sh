...
finemo call-hits -r motif_calls_counts.npz -m modisco_counts/modisco_results_counts.h5 -o finemo_out -p ${celltype}_peakset_all_no_blacklist.bed -J
finemo report -r motif_calls_counts.npz -H finemo_out/${celltype}_hits_counts.tsv -p ${celltype}_peakset_all_no_blacklist.bed -m modisco_counts/modisco_results_counts.h5 -o finemo_out/report_counts -W 2000
else
...
finemo call-hits -r motif_calls_profile.npz -m modisco_profile/modisco_results_profile.h5 -o finemo_out -p ${celltype}_peakset_all_no_blacklist.bed -J
finemo report -r motif_calls_profile.npz -H finemo_out/${celltype}_hits_profile.tsv -p ${celltype}_peakset_all_no_blacklist.bed -m modisco_profile/modisco_results_profile.h5 -o finemo_out/report_profile -W 2000
else

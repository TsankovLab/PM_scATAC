...
MODEL_H5=/sc/arion/projects/Tsankov_Normal_Lung/Bruno/mesothelioma/scATAC_PM/NKT_cells/scatac_ArchR/chromBPnet/${celltype}_model/fold_$fold_number/models/chrombpnet_no_bias.h5

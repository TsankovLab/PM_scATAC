...
# Set project dir
projdir = '/sc/arion/projects/Tsankov_Normal_Lung/Bruno/mesothelioma/scATAC_PM/Fibroblasts/scrna'
...
png (file.path('Plots',paste0('top_',top_genes,'_heatmap.png')), height=3500, width=5300, res=400)
print (heat_p)
dev.off()
rm (srt2)

...
pdf (file.path('Plots','myeloid_markers_fplots.pdf'), width = 8, height = 5)
wrap_plots (p, ncol=3)
dev.off()
...
archp$celltype = 0
archp$celltype[archp$Clusters_H %in% c('C5','C6','C7')] = 'Monocytes'
archp$celltype[archp$Clusters_H %in% c('C1','C2','C3','C4')] = 'Macs'

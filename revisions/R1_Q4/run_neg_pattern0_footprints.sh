#!/bin/bash
# run_neg_pattern0_footprints.sh  (R1_Q4)
#
...
#
# Submit: bsub < run_neg_pattern0_footprints.sh
#BSUB -J neg_pattern0_footprints
...
#BSUB -R "span[hosts=1]"
#BSUB -o /sc/arion/projects/Tsankov_Normal_Lung/Bruno/mesothelioma/scATAC_PM/git_repo_claude/logs/neg_pattern0_footprints_%J.out
#BSUB -e /sc/arion/projects/Tsankov_Normal_Lung/Bruno/mesothelioma/scATAC_PM/git_repo_claude/logs/neg_pattern0_footprints_%J.err
...
OUT_DIR=/sc/arion/scratch/giottb01/Xmen/meso/footprints_neg_pattern0
MOTIF_FILE=${OUT_DIR}/motif_footprints_neg_pattern0.txt
...
# ── Average folds + plot ──────────────────────────────────────────────────────
PLOT_SCRIPT=/sc/arion/projects/Tsankov_Normal_Lung/Bruno/mesothelioma/scATAC_PM/git_repo_claude/R1_Q4/plot_neg_pattern0_footprints.py

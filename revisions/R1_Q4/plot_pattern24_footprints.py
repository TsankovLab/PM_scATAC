#!/usr/bin/env python3
"""
plot_pattern24_footprints.py  (R1_Q4)

Averages ChromBPNet footprint H5 files across 5 folds per cell type,
then overlays the pattern24_AP1_NR4A2 footprint profile for all 6 NKT
...
MOTIF_GROUP = "pattern24_AP1_NR4A2"
...
OUT_PDF = ("/sc/arion/projects/Tsankov_Normal_Lung/Bruno/mesothelioma/"
           ...
           "pattern24_chrombpnet_footprints.pdf")
...
def main():
    ...
    ax.set_title(
        "pos_patterns.pattern_24 — AP-1 + NR4A2 composite\n"

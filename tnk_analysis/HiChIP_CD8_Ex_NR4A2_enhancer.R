...
pdf (file.path ('Plots','HiC_map_iced_normalized2.pdf'),height=3,width=4)
...
samples_CD19 = c('SRR13961071','SRR13961072')
samples_HA = c('SRR13961073','SRR13961074')
# Focus on chr2:156312347−156492348

#chr2 156292347−156642348
E14subset_CD19_1 = extractRegion(hic[[samples_CD19[1]]]$chr2chr2, c(1,2),
chr="chr2", from=156292347, to=156642348)
E14subset_CD19_2 = extractRegion(hic[[samples_CD19[2]]]$chr2chr2, c(1,2),
chr="chr2", from=156292347, to=156642348)

E14subset_CD19_1.binned <- binningC (E14subset_CD19_1, binsize=10000, method="mean", step=3)
E14subset_CD19_2.binned <- binningC (E14subset_CD19_2, binsize=10000, method="mean", step=3)
E14subset_CD19_1.binned <- normPerExpected (E14subset_CD19_1.binned, method="loess", stdev=TRUE)
E14subset_CD19_2.binned <- normPerExpected (E14subset_CD19_2.binned, method="loess", stdev=TRUE)

E14subset_CD19_avg.binned = E14subset_CD19_2.binned
E14subset_CD19_avg.binned@intdata = (E14subset_CD19_1.binned@intdata + E14subset_CD19_2.binned@intdata) / 2



E14subset_HA_1 = extractRegion(hic[[samples_HA[1]]]$chr2chr2, c(1,2),
chr="chr2", from=156292347, to=156642348)
E14subset_HA_2 = extractRegion(hic[[samples_HA[2]]]$chr2chr2, c(1,2),
chr="chr2", from=156292347, to=156642348)

E14subset_HA_1.binned <- binningC (E14subset_HA_1, binsize=10000, method="mean", step=3)
E14subset_HA_2.binned <- binningC (E14subset_HA_2, binsize=10000, method="mean", step=3)
E14subset_HA_1.binned <- normPerExpected (E14subset_HA_1.binned, method="loess", stdev=TRUE)
E14subset_HA_2.binned <- normPerExpected (E14subset_HA_2.binned, method="loess", stdev=TRUE)

E14subset_HA_avg.binned = E14subset_HA_2.binned
E14subset_HA_avg.binned@intdata = (E14subset_HA_1.binned@intdata + E14subset_HA_2.binned@intdata) / 2
...
E14subset_subtracted2@intdata = E14subset_CD19_avg.binned@intdata - E14subset_HA_avg.binned@intdata

pdf (file.path (projdir,'Plots','HiC_map_diff2.pdf'),height=3,width=4)
mapC (E14subset_subtracted, maxrange=10)
mapC (E14subset_HA_avg.binned, maxrange=10)
mapC (E14subset_CD19_avg.binned, maxrange=10)
#mapC(E14norm.binned[[samples[1]]] - E14norm.binned[[samples[6]]],
#tracks=list(RefSeqGene=gene, CTCF=ctcf),

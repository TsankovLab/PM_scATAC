#!/bin/bash
#BSUB -J chrbp_model_CD4_contribution
...
MODEL_H5=/sc/arion/projects/Tsankov_Normal_Lung/Bruno/mesothelioma/scATAC_PM/NKT_cells/scatac_ArchR/chromBPnet/CD4_model/models/chrombpnet.h5
REGIONS=peakset_NK_CD4.bed
GENOME=../../../../../genome_references/hg38.genome.fa
CHROM_SIZES=../../../../../chromBPnet/hg38.chrom.sizes
OUTPUT_PREFIX=CD4_contribution_scores
